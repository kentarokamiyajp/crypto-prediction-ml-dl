...
class GenericDataFormatter(abc.ABC):
    ...
    def _get_tft_input_indices(self):
        ...
        # Start extraction
        column_definition = [tup for tup in self.get_column_definition() if tup[2] not in {InputTypes.ID, InputTypes.TIME}]
    ...
    def get_experiment_params(self):
        ...
        required_keys = ["total_time_steps", "num_encoder_steps", "num_epochs", "early_stopping_patience", "multiprocessing_workers"]
