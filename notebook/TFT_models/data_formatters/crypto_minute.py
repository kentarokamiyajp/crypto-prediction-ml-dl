...
class CryptoMinuteFormatter(GenericDataFormatter):
    """Defines and formats data for the crypto_minute dataset.
    ...
    _column_definition = [
        ("row_id", DataTypes.REAL_VALUED, InputTypes.STATIC_INPUT),
        ("symbol_id", DataTypes.CATEGORICAL, InputTypes.ID),
        ("ts", DataTypes.DATE, InputTypes.TIME),
        ...
        ("total_volume", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("total_quantity", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("total_trade_count", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("buy_trade_count", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("sum_buy_taker_amount", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("sum_buy_taker_quantity", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("avg_buy_trade_price", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("sell_trade_count", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("sum_sell_taker_amount", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("sum_sell_taker_quantity", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ("avg_sell_trade_price", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
    ...
    def split_data(self, df, valid_boundary=90000, test_boundary=100000):
